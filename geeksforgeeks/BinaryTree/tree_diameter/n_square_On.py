...
class Solution:
    ...
    def solution(self,root,height) :
        ...
        ldiameter , lheight = self.solution(root.left, lheight)
        rdiameter , rheight = self.solution(root.right , rheight)
    ...
    def diameter(self,root):
        if root is None :
            return 0
        max_dia , height = self.solution(root,0)
        return max_dia
        # Code here
